...
def oidc_callback(request):
    """View to capture OIDC redirect payload."""
    # Extract all query parameters
    payload = request.GET.dict()
    print("OIDC Callback Payload:", payload)
    
    
    # You can add logic here to process/store the payload as needed
    return render(request, "catalog/oidc_callback.html", {"payload": payload})
